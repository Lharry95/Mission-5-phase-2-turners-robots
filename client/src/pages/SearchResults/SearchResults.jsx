        ...
        <div className="quickviewOverlay">
          <div className="quickviewMain">
            <button
              ...
              onClick={() =>
                setCurrentListing(
                  (prev) => (prev - 1 + listings.length) % listings.length
                )
              }
            >
              <span>&#8592;</span>
            ...
            <div className="quickviewListing">
              <div className="quickviewMainContent">
                ...
                <div className="quickLeft">
                  <img
                    src={fetchImagePath(listings[currentListing].image)}
                ...
                <div className="quickRight">
                  <button
                    className="quickWatchlist"
                    onClick={() =>
                      watchlistToggle(listings[currentListing]._id)
                    }
                  >
                    <img
                      src={
                        watchlist[listings[currentListing]._id]
                          ? icon_binoculars_minus
                          : icon_binoculars_plus
                      }
                    />
                  </button>
      ...
      <div className="searchResultsMain">
        <div className="searchResultsHeader">
          <div className="resultsShown">
            Showing {listings.length} results for '{query}'
          </div>
          ...
          {listings.map((listing) => (
            <div key={listing._id} className="listingCard">
              <div className="imageArea">
                <img
                  src={fetchImagePath(listing.image)}
                  alt={listing.title}
                ...
                <button
                  ...
                  onClick={() => {
                    setQuickview(true);
                    setCurrentListing(
                      listings.findIndex((index) => index._id === listing._id)
                    );
                  }}
                >
                  <img src={icon_eye} />
                ...
                <button
                  className="rightIcon"
                  onClick={() => watchlistToggle(listing._id)}
                >
                  <img
                    src={
                      watchlist[listing._id]
                        ? icon_binoculars_minus
                        : icon_binoculars_plus
                    }
                  />
